...
class MeditationScreen extends StatefulWidget {
  final bool returnWhenComplete;

  const MeditationScreen({
    super.key,
    this.returnWhenComplete = false,
  });

  @override
  State<MeditationScreen> createState() => _MeditationState();
}
...
class _MeditationState extends State<MeditationScreen>
  ...
  static const String _meditationVideoId = '8ln4XfRi6uw';
  ...
  void initState() {
    ...
    // youtube_player_flutter 10.x API.
    _youtubeController = YoutubePlayerController.fromVideoId(
      videoId: _meditationVideoId,
      autoPlay: false,
  ...
  void _start(int idx) {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (_) {
      ...
      if (_elapsed >= total) {
        ...
        if (widget.returnWhenComplete && mounted) {
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Science-backed techniques from clinical recovery research.',
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Play this guided session when you want to slow down, breathe, and create some space from the urge.',
                            style: TextStyle(
